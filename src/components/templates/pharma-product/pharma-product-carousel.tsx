...
import type { ResolvedPharmaTheme } from "./pharma-product-theme";
...
export function PharmaProductCarousel({ images, productName, t }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        {images.map((url, i) => (
          <div key={i} className="relative aspect-square min-w-full shrink-0 snap-center bg-white dark:bg-black/20">

...
export const metadata: Metadata = {
  title: resolveTitle("Privacy Policy — ClickPath"),
  description: resolveDescription(
    "Learn how ClickPath collects, uses, and protects your personal information.",
  ),
  alternates: {
    ...
    <main style={{ background: "var(--warm-bg)", color: "var(--warm-ink)" }}>
      <JsonLd
        data={createBreadcrumbSchema([
          ...
          { name: "Privacy Policy", url: resolveCanonical("/privacy") },
        ])}
      />
      <Header />
      ...
      <section style={{ padding: "24px 0 120px" }}>
        ...
        >
          <p>
            At ClickPath, we take your privacy seriously. This Privacy Policy explains how we
            collect, use, disclose, and safeguard your information when you use our URL shortening
            service at clickpath.analytai.in. Please read this policy carefully. By using ClickPath,
          ...
          <ul>
            <li>
              ...
              provider when you create an account.
            </li>
          ...
          <ul>
            ...
            <li>
              Interaction data such as features used, pages visited, and actions taken within the
              service.
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              including: IP address (anonymized), browser type and version, operating system, device
              type, referring website, approximate geographic location (country and city), and
              timestamp of the click.
            </li>
            <li>
              This analytics data is collected to provide link creators with insights about their
              audience and link performance.
            </li>
          </ul>
          ...
          <ul>
            <li>Provide, maintain, and improve the ClickPath service.</li>
            <li>Create and manage your account and process your requests.</li>
            <li>Generate click analytics and performance reports for your shortened links.</li>
            <li>Detect and prevent abuse, spam, phishing, and malicious use of our service.</li>
            <li>
              Send you service-related communications, such as account notifications and updates.
            </li>
            <li>
              Enforce our Terms of Service and ensure compliance with our acceptable use policies.
            </li>
            <li>Analyze usage trends to improve the user experience and develop new features.</li>
          </ul>
          ...
          <ul>
            <li>
              <strong>Service providers:</strong> We use third-party services to operate our
              platform. These include Clerk for authentication and account management, and analytics
              providers for service monitoring. These providers only have access to the information
              necessary to perform their functions and are obligated to protect your data.
            </li>
            <li>
              <strong>Legal requirements:</strong> We may disclose your information if required to
              do so by law, court order, or governmental request, or if we believe disclosure is
          ...
          <p>
            Link analytics data (click counts, geographic distribution, device breakdowns) is
            visible to the user who created the shortened link. This data does not include
            personally identifiable information about the individuals who clicked the link.
          </p>

          <h2>4. Cookies</h2>

          <p>
            ClickPath uses cookies and similar technologies to maintain your session, remember your
            preferences, and provide a secure experience. We use:
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            your account, we will remove your personal information and link data within 30 days,
            except where we are required to retain it for legal or compliance purposes.
          </p>
          <p>
            Aggregated and anonymized analytics data may be retained indefinitely as it cannot be
          ...
          <p>
            ...
            encryption in transit (TLS/SSL), secure data storage, and access controls. However, no
          ...
          <ul>
            ...
            <li>
              <strong>Correction:</strong> Request that we correct any inaccurate or incomplete
              information.
            </li>
            <li>
              <strong>Deletion:</strong> Request that we delete your personal information and
              account data.
            </li>
            <li>
          ...
          <p>
            ClickPath is not intended for use by children under the age of 13. We do not knowingly

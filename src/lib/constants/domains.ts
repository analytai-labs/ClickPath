...
export const PLATFORM_DOMAINS = ["clickpath.analytai.in", "clk.path"] as const;
...
// Clerk is configured on the full ClickPath domain, so authenticated app/team
// navigation must stay on this host instead of the shorter link domain.
export const APP_BASE_DOMAIN = "clickpath.analytai.in";
...
// at a non-prod host instead of baking clickpath.analytai.in into outbound links.
...
// domain (e.g. "acme.clk.path" -> "acme"). Returns null for bare platform

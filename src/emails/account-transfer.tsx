...
export const AccountTransferEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>{senderName} wants to transfer their ClickPath resources to you</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            ...
            <Text style={text}>
              <strong>{senderName}</strong> ({senderEmail}) has requested to transfer their
              ClickPath resources to your account.
            </Text>

...
<p align="center">
  <a href="https://ClickPath">ClickPath</a> &nbsp;·&nbsp;
...
<p align="center">
  <a href="https://github.com/Shlok-Zanwar/ClickPath/blob/main/LICENSE">
    <img src="https://img.shields.io/github/license/Shlok-Zanwar/ClickPath" alt="License" />
  </a>
  <a href="https://github.com/Shlok-Zanwar/ClickPath/stargazers">
    <img src="https://img.shields.io/github/stars/Shlok-Zanwar/ClickPath" alt="Stars" />
  </a>
  <a href="https://github.com/Shlok-Zanwar/ClickPath/network/members">
    <img src="https://img.shields.io/github/forks/Shlok-Zanwar/ClickPath" alt="Forks" />
  </a>
  <a href="https://github.com/Shlok-Zanwar/ClickPath/issues">
    <img src="https://img.shields.io/github/issues/Shlok-Zanwar/ClickPath" alt="Issues" />
  </a>
</p>
...
ClickPath is an open-source URL shortener and link intelligence platform. It turns long URLs into short, branded links and gives you deep insight into every click — country, city, device, referrer, and hour-by-hour trends — without shipping third-party cookies or chasing visitors across the web.
...
<p align="center">
  <img src=".github/assets/dashboard-links.png" alt="ClickPath dashboard listing links" width="100%" />
</p>
...
<p align="center">
  <img src=".github/assets/analytics-dashboard.png" alt="ClickPath analytics view for a single link" width="100%" />
</p>
...
```bash
git clone https://github.com/Shlok-Zanwar/ClickPath.git
cd ClickPath
bun install
```
...
| --- | --- | --- |
| `DATABASE_URL` | `mysql://clickpath:clickpath@localhost:3306/clickpath_rewrite` | MySQL connection string |
...
1. [Open an issue](https://github.com/Shlok-Zanwar/ClickPath/issues) describing the problem or idea first, especially for larger changes.
